							...
							<table id="example2" class="table table-striped table-bordered">
								<thead>
									<tr>
										...
										<th style="background-color:#6DB9EF;">Platform</th>
...
?>
    ...
    <tr style="text-align:center;">
        ...
        <td>
        <a href="approvedSong.php?Key=<?php echo $row['content_unicode'];?>" class="btn btn-warning rounded-0">Add to Platform</a></td>
    </tr>
