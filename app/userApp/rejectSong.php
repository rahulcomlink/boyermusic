...
?>
       <main class="page-content">				
				<h5 class="mb-0 text-uppercase" style="color:#03C988;">[ Reject Song List ] </h5>
				<hr />
				<div class="card">
					<div class="card-body">
							...
							<table id="example2" class="table table-striped table-bordered">
								<thead>
									<tr>
                                        ...
                                        <th style="background-color:#6DB9EF;">Hold</th>
...
?>
    ...
    <tr style="text-align:center;">
        ...
        <td>
        <a href="approvedSong.php?Key=<?php echo $row['content_unicode'];?>" class="btn btn-warning rounded-0">Approved</a></td>
        
        
        <td><a href="approvedSong.php?Key=<?php echo $row['content_unicode'];?>" class="btn btn-danger rounded-0">Hold</a></td>
    </tr>
