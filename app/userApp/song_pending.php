...
WHERE songs.content_status = 'PENDING'"; 
...
?>
    ...
    <tr style="text-align:left;font-size:18px;vertical-align:text-top;text-color:black;">
        ...
        <td>
            <a href="song_approved.php?Key=<?php echo $row['content_unicode'];?>" class="btn" style="box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;width:100%;font-size:18px;background:#06D001;color:white"><i class="fa-solid fa-square-check"></i>  Approved</a>
        </td>
        <td>
            <a href="approvedSong.php?Key=<?php echo $row['content_unicode'];?>" class="btn" style="box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;width:100%;font-size:18px;background:#088395;color:white"><i class="fa-solid fa-bug" style="color: #d66000;"></i>  Reject</a>
        </td>
