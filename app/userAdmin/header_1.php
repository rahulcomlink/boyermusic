...
<head>
  ...
  <link href="<?php echo getUrlAsset() ?>/assets/css/custom.css" rel="stylesheet" />
              ...
              <li class="nav-item dropdown dropdown-large">
                <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown">
                  <div class="user-setting d-flex align-items-center gap-1">
                    ...
                    <div class="user-name d-none d-sm-block"><?php echo "Shri Boyer Music"; ?></div>
                  </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
                  <li>
                   ...
                   <li>
                    ...
                    <li>
                      <a class="dropdown-item" href="bankDetails.php">
                         <div class="d-flex align-items-center">
        ...
        <aside class="sidebar-wrapper">
          ...
          <div class="textmenu">
            ...
            <div class="tab-content">
              <div class="tab-pane show" id="pills-dashboards">
              ...
              <div class="tab-pane fade" id="pills-application">
                <div class="list-group list-group-flush">
                  ...
                  <a href="amazon_upload.php" class="list-group-item"><i class="bi bi-envelope"></i>Amazon</a>
                  <a href="airtel_upload.php" class="list-group-item"><i class="bi bi-envelope"></i>Airtel</a>
                  <a href="vodafone_upload.php" class="list-group-item"><i class="bi bi-envelope"></i>Vodafone</a>
                  <a href="facebook_upload.php" class="list-group-item"><i class="bi bi-envelope"></i>Facebook</a>
                  <a href="spotify_upload.php" class="list-group-item"><i class="bi bi-envelope"></i>Spotify</a>
                  <a href="tiktok_upload.php" class="list-group-item"><i class="bi bi-envelope"></i>Tiktok</a>
                  <a href="resso_upload.php" class="list-group-item"><i class="bi bi-envelope"></i>Resso</a>
                  <a href="apple_upload.php" class="list-group-item"><i class="bi bi-envelope"></i>Apple</a>
                  <a href="jiosaavn_upload.php" class="list-group-item"><i class="bi bi-envelope"></i>Jiosaavn</a>
                  <a href="bsnl_upload.php" class="list-group-item"><i class="bi bi-envelope"></i>BSNL</a>
                </div>
              </div>
              ...
              <div class="tab-pane fade" id="pills-ecommerce">
                <div class="list-group list-group-flush">
                  ...
                  <a href="amazon_balance.php" class="list-group-item"><i class="bi bi-envelope"></i>Amazon</a>
                  <a href="airtel_balance.php" class="list-group-item"><i class="bi bi-envelope"></i>Airtel</a>
                  <a href="vodafone_balance.php" class="list-group-item"><i class="bi bi-envelope"></i>Vodafone</a>
                  <a href="facebook_balance.php" class="list-group-item"><i class="bi bi-envelope"></i>Facebook</a>
                  <a href="spotify_balance.php" class="list-group-item"><i class="bi bi-envelope"></i>Spotify</a>
                  <a href="tiktok_balance.php" class="list-group-item"><i class="bi bi-envelope"></i>Tiktok</a>
                  <a href="resso_balance.php" class="list-group-item"><i class="bi bi-envelope"></i>Resso</a>
                  <a href="apple_balance.php" class="list-group-item"><i class="bi bi-envelope"></i>Apple</a>
                  <a href="jiosaavn_balance.php" class="list-group-item"><i class="bi bi-envelope"></i>Jiosaavn</a>
                  <a href="bsnl_balance.php" class="list-group-item"><i class="bi bi-envelope"></i>BSNL</a>
                </div>
              </div>
