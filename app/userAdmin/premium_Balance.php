            ...
            while ($row = $result->fetch_assoc()) {
                if($row['content_isPremium'] == "Yes"){
                    ...
                    if ($balance >= $date) {
                        ...
                        echo '<td style="font-weight:700;">₹' . number_format($Percent10, 2) . '</td>';
                        echo '<td style="font-weight:700;">' . $row['balance_date'] . '</td>';
                        echo '<td style="font-weight:700;">' . date('Y-m-d', strtotime($checkDate)) . '</td>';
                    } else {
