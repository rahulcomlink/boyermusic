              ...
              <li class="nav-item dropdown dropdown-large">
                <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown">
                  <div class="user-setting d-flex align-items-center gap-1">
                    ...
                    <div class="user-name d-none d-sm-block">Boyer Music</div>
                  </div>
                </a>
          ...
          <ul class="metismenu" id="menu" style="margin-top:1px !important">
            ...
            <li>
              <a href="javascript:;" class="has-arrow" style="color:white;">
                <div class="parent-icon"><i class="fa-solid fa-money-check"></i>
                </div>
                <div class="menu-title" style="color:white;font-weight:700">Balance</div>
              </a>

              <ul style="padding-left:20px">
                <li> <a href="allBalance.php" style="color:white;font-weight:700px;"><i class="fa-solid fa-circle-info"></i>Balance Record</a>
                </li>
                <li> <a href="balanceUpload.php" style="color:white;font-weight:700px;"><i class="fa-solid fa-upload"></i></i>Balance Upload</a>
                </li>
              </ul>
            </li>
            ...
            <li> <a href="listedSong.php" style="color:white;font-weight:700px;"><i class="fa-brands fa-creative-commons-sampling-plus"></i>All Songs</a>
            </li>

            <li> <a href="song_pending.php" style="color:white;font-weight:700px;"><i class="fa-solid fa-clock"></i>Pending Song</a>
            </li>

            <li> <a href="song_list.php" style="color:white;font-weight:700px;"><i class="fa-solid fa-vault"></i>Song Bank</a>
            </li>

            <li> <a href="song_premium.php" style="color:white;font-weight:700px;"><i class="fa-solid fa-crown"></i>Premium Song</a>
            </li>
            ...
            <li >
              ...
              <ul>
                ...
                <li> <a href="filterPremiumProduction.php" style="color:white;font-weight:700px;"><i class="fa-solid fa-clapperboard"></i>Production Report</a>
                </li>

                <li> <a href="activeUser.php" style="color:white;font-weight:700px;"><i class="fa-solid fa-users-viewfinder"></i>Active Users</a>
                </li>
            ...
            <li >
              ...
              <ul>
                ...
                <li> <a href="filterProduction.php" style="color:white;font-weight:700px;"><i class="fa-solid fa-clapperboard"></i>Production Report</a>
                </li>
            ...
            <li >
              ...
              <ul>
              <li> <a href="createPlatform.php" style="color:white;font-weight:700px;"><i class="fa-solid fa-list"></i>Add Platform</a>
                </li>
                <li> <a href="platformList.php" style="color:white;font-weight:700px;"><i class="fa-solid fa-circle-nodes"></i>Available Platform</a>
                </li>
