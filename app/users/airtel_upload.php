...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_FILES["fileToUpload"])) {
        ...
        foreach ($csv as $row) {
            ...
            $sql = "INSERT INTO `airtel_balance`(`songname`, `album_name`, `language`, `label`, `Main_Label`, `Sub_Label`, `Label_Identification`, `total`, `income`, `admin_Exp`, `royality`, `id`, `file`, `original_l1_name`, `original_l2_name`, `createdAt`) VALUES ('$escapedRow[0]', '$escapedRow[1]', '$escapedRow[2]', '$escapedRow[3]', '$escapedRow[4]', '$escapedRow[5]', '$escapedRow[6]', '$escapedRow[7]', '$escapedRow[8]', '$escapedRow[9]', '$escapedRow[10]', '$escapedRow[11]', '$escapedRow[12]', '$escapedRow[13]', '$escapedRow[14]','$userProvidedDate')";
