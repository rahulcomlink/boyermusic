...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_FILES["fileToUpload"])) {
        ...
        foreach ($csv as $row) {
            ...
            $sql = "INSERT INTO jiosaavn_balance (sr_no, song_name, album_name, artist_name, isrc, upc, language, label, Main_Label, Sub_Label, Label_Identification, ad_supported_streams, subscription_streams, jio_trial_streams, total_streams, income, admin_Exp, royality, original_l1_name, original_l2_name, createdAt) VALUES ('$escapedRow[0]', '$escapedRow[1]', '$escapedRow[2]', '$escapedRow[3]', '$escapedRow[4]', '$escapedRow[5]', '$escapedRow[6]', '$escapedRow[7]', '$escapedRow[8]', '$escapedRow[9]', '$escapedRow[10]', '$escapedRow[11]', '$escapedRow[12]', '$escapedRow[13]', '$escapedRow[14]', '$escapedRow[15]', '$escapedRow[16]', '$escapedRow[17]', '$escapedRow[18]', '$escapedRow[19]', '$userProvidedDate')";
