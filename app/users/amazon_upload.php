...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_FILES["fileToUpload"])) {
        ...
        foreach ($csv as $row) {
            ...
            $sql = "INSERT INTO amazon_balance (dataset_date, territory_code, subscription_plan, streams, offline_plays, total, track_asin, isrc, proprietary_track_id, song_name, proprietary_album_id, digital_album_upc, album_name, artist_name, label, Main_Label, Sub_Label, Label_Identification, track_quality, ratecard_currency, settlement_currency, asset_type, income, admin_Exp, royality, id, original_l1_name, original_l2_name, company, createdAt) VALUES ('$escapedRow[0]', '$escapedRow[1]', '$escapedRow[2]', '$escapedRow[3]', '$escapedRow[4]', '$escapedRow[5]', '$escapedRow[6]', '$escapedRow[7]', '$escapedRow[8]', '$escapedRow[9]', '$escapedRow[10]', '$escapedRow[11]', '$escapedRow[12]', '$escapedRow[13]', '$escapedRow[14]', '$escapedRow[15]', '$escapedRow[16]', '$escapedRow[17]', '$escapedRow[18]', '$escapedRow[19]', '$escapedRow[20]', '$escapedRow[21]', '$escapedRow[22]', '$escapedRow[23]', '$escapedRow[24]', '$escapedRow[25]', '$escapedRow[26]', '$escapedRow[27]', '$escapedRow[28]', '$userProvidedDate')";
