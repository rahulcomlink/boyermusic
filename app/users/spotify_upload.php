...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_FILES["fileToUpload"])) {
        ...
        foreach ($csv as $row) {
            ...
            $sql = "INSERT INTO spotify_balance (country, label, main_label, sub_label, label_identification, product, uri, upc, ean, isrc, song_name, artist_name, composer_name, album_name, total, file_name, income, admin_exp, royalty, id, original_l1_name, original_l2_name, company, createdAt) VALUES ('$escapedRow[0]', '$escapedRow[1]', '$escapedRow[2]', '$escapedRow[3]', '$escapedRow[4]', '$escapedRow[5]', '$escapedRow[6]', '$escapedRow[7]', '$escapedRow[8]', '$escapedRow[9]', '$escapedRow[10]', '$escapedRow[11]', '$escapedRow[12]', '$escapedRow[13]', '$escapedRow[14]', '$escapedRow[15]', '$escapedRow[16]', '$escapedRow[17]', '$escapedRow[18]', '$escapedRow[19]', '$escapedRow[20]', '$escapedRow[21]', '$escapedRow[22]', '$userProvidedDate')";
