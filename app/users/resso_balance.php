...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_FILES["fileToUpload"])) {
        ...
        foreach ($csv as $row) {
            ...
            $sql = "INSERT INTO `resso_balance`(`service_name`, `service_dpid`, `report_start_date`, `report_end_date`, `isrc`, `UPC`, `grid`, `platform_track_id`, `platform_album_id`, `artist_name`, `album_name`, `song_name`, `label`, `content_provider`, `Main_Label`, `Sub_Label`, `Label_Identification`, `service_tier`, `country`, `total`, `income`, `admin_Exp`, `royality`, `original_l1_name`, `original_l2_name`, `createdAt`) VALUES  ('$escapedRow[0]', '$escapedRow[1]', '$escapedRow[2]', '$escapedRow[3]', '$escapedRow[4]', '$escapedRow[5]', '$escapedRow[6]', '$escapedRow[7]', '$escapedRow[8]', '$escapedRow[9]', '$escapedRow[10]', '$escapedRow[11]', '$escapedRow[12]', '$escapedRow[13]', '$escapedRow[14]', '$escapedRow[15]', '$escapedRow[16]', '$escapedRow[17]', '$escapedRow[18]', '$escapedRow[19]', '$escapedRow[20]', '$escapedRow[21]', '$escapedRow[22]', '$escapedRow[23]', '$escapedRow[24]','$userProvidedDate')";
