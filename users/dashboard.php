                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="">
                        ...
                        <h4 class="mb-0 text-white">₹{{totalRevenue}}</h4>
                      </div>
                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="">
                        ...
                        <h4 class="mb-0 text-white">{{totalSong}}</h4>
                      </div>
                      <div class="ms-auto widget-icon bg-white-1 text-white">
                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="">
                        ...
                        <h4 class="mb-0 text-white">{{totalPending}}</h4>
                      </div>
                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="">
                        ...
                        <h4 class="mb-0 text-white">{{totalPremium}}</h4>
                      </div>
                      <div class="ms-auto widget-icon bg-white-1 text-white">
...
<div id="chartContainer" data-user-counts="{{userCountsByMonthAndStateJSON}}"></div>
        </div>
      </div>
    </div>
      ...
      <div class="card radius-10">
        <div class="card-body">
          <div class="d-flex align-items-end">
            ...
            <div class="ms-auto">
              <p class="mb-0 text-danger">1.5% <i class="bi bi-arrow-up"></i>
              </p>
            </div>
          </div>
          <div id="chart2"></div>
        ...
        <div class="col-12 col-lg-4 col-xl-4 d-flex">
          <div class="card mb-0 radius-10 border shadow-none w-100">
            <div class="card-body">
              ...
              <h4 class="mt-4">$36.2K <i class="flag-icon flag-icon-us rounded"></i>
              </h4>
        ...
        <div class="new-customer-list p-3">
          <div class="d-flex align-items-center gap-3 customer-list-item">
            ...
            <div class="d-flex align-items-center gap-3 fs-6 ms-auto">
              <a href="javascript:;" class="text-secondary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="Message" aria-label="Message">
                <i class="bi bi-envelope-fill"></i>
              </a>
              <a href="javascript:;" class="text-secondary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="Delete" aria-label="Delete">
